...
class MyTest(unittest.TestCase):
    ...
    def test_qn_0(self):
        ...
        sol = sample.solver(x0, fun=fun, g=stop_fun, fun_jac=fun_jac, tol=1e-6, eps=1e-10, max_steps=300, method='quasinewton', verbose=True, regularise=True, full_return = False)
