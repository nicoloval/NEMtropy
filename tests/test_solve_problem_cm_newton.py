...
class MyTest(unittest.TestCase):
    ...
    def test_fixedpoint_cm_5(self):
        ...
        g._solve_problem(model='cm-new', method='newton', max_steps=100, verbose=False,  linsearch = True)
    ...
    def test_fixedpoint_cm_6(self):
        ...
        g._solve_problem(model='cm-new', method='newton', max_steps=300, verbose=False, linsearch = 'True')
