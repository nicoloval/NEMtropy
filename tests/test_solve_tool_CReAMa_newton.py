...
class MyTest(unittest.TestCase):
    ...
    def test_CReAMa_original_newton_random_dense_20_dir(self):
    ...
    def test_CReAMa_cm_newton_random_dense_20(self):
        ...
        g.solve_tool(model='CReAMa', method='quasinewton', adjacency='cm-new',  max_steps=1000, verbose=False)
    ...
    def test_CReAMa_original_newton_random_dense_20_undir(self):
